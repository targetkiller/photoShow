...
(function() {
	...
	Book.prototype._open = function() {
		...
		var self = this,
			onOpenBookEndFn = function( ev ) {
				...
				$(scrollWrap).addClass('hide-overflow');
			};
	...
	Book.prototype._close = function() {
		...
		$(scrollWrap).removeClass('hide-overflow');
		...
		$(this.bbWrapper).removeClass('show');
		$(this.bbWrapper).addClass('hide');
		...
		var self = this,
			onCloseBookEndFn = function( ev ) {
				...
				$(self.bbWrapper).removeClass('hide');
			};
